...
typedef struct
{
    ...
    uint16                           slaves;                                     /**< \brief Specifies the number of slaves configured (Bit0: Slave 0(IfxVadc_GroupId_0 ), Bit1: slave 1(IfxVadc_GroupId_1),.....Bit10: Slave 10(IfxVadc_GroupId_10) */
 ...
 */
IFX_INLINE boolean IfxVadc_isResultAvailable(IfxVadc_Adc_Channel *channel);
