...
typedef struct
{
    ...
    uint16                           slaves;                                     /**< \brief Specifies the number of slaves configured (Bit0: Slave 0(IfxVadc_GroupId_0 ), Bit1: slave 1(IfxVadc_GroupId_1),.....Bit8: Slave 8(IfxVadc_GroupId_8) */
